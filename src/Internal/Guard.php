...
/**
 * Geometry preconditions shared by every field.
 *
 * These checks reject invalid dimensions, counts and proportions. Finite
 * inputs alone do not guarantee useful output at extreme numerical scales.
 *
 * @internal
 */
final class Guard
